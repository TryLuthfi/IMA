...
import indonesia.asperindo.com.asperindo.adapter.GaleryAdapter;
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                if (mPostKeyIDACARA.equals(jo.getString("id_acara"))) {
                    ...
                    Glide.with(getApplicationContext()).load("http://imaindonesia.000webhostapp.com/acara/" + gambarAcara).into(iv_header);
    ...
    private void gambarPreview(final String gambarAcara) {
        iv_header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                            ...
                            Glide.with((getApplicationContext())).load("http://imaindonesia.000webhostapp.com/acara/" + gambarAcara).into(gambar);
