        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                if (mPostKeyIdArtikel.equals(jo.getString("id_artikel"))) {
                    ...
                    Glide.with(getApplicationContext()).load("http://imaindonesia.000webhostapp.com/acara/" + gambarArtikel).into(iv_header);
    ...
    private void gambarPreview(final String gambarArtikel) {
        iv_header.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with((getApplicationContext())).load("http://imaindonesia.000webhostapp.com/acara/" + gambarArtikel).into(gambar);
